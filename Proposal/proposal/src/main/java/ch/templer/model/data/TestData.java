...
public class TestData {
    ...
    private void generateTestData() {
        ...
        multipleChoiceModel.setFragmentColors(fragmentColors);
        multipleChoiceModel.setBackgroundColor(Colors.White);
        multipleChoiceModel.setQAndA(qAndAs);
        multipleChoiceModel.setTitle("Quiz 1 - Easy");
